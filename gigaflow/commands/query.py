...
_SCHEMA = """
  ...
  Flow run (latest run only; all NULL if Flow not yet computed)
  ...
  Flow metrics (NULL until gigaflow compute is run)
...
def register(sub) -> None:
    p = sub.add_parser(
        ...
        description=(
            ...
            "span counts, and the latest Flow results. Use this to explore your data "
